 ...
 */
if ( ! function_exists( 'largo_register_term_meta_post_type' ) ) {
 ...
 * @param bool $unique
 */
if ( ! function_exists( 'largo_add_term_meta' ) ) {
 ...
 * @param mixed $meta_value
 */
if ( ! function_exists( 'largo_delete_term_meta' ) ) {
 ...
 * @param bool $single
 */
if ( ! function_exists( 'largo_get_term_meta' ) ) {
 ...
 */
if ( ! function_exists( 'largo_update_term_meta' ) ) {
