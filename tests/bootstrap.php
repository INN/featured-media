<?php
/**
 * Largo_Featured_Media Test Bootstrapper.
 *
 * @since   0.1.0
 ...
 * @since 0.1.0
 */
function _manually_load_largo_featured_media_plugin() {
	...
	// Require our plugin.
	require dirname( dirname( __FILE__ ) ) . '/largo-featured-media.php';
}

// Inject in our plugin.
tests_add_filter( 'muplugins_loaded', '_manually_load_largo_featured_media_plugin' );
